...
if __name__ == "__main__":
    ...
    prelastAccResultFilePath = '../report/prelastAcc.txt'
    findex = open(prelastAccResultFilePath,'w+')
    print(trainpreAcc,trainlastAcc,bigTrainpreAcc,bigTrainlastAcc)

    print(trainpreAcc,trainlastAcc,bigTrainpreAcc,bigTrainlastAcc,file=findex)
