...
def training_vis(hist):
    ...
    #pretrain训练出来的png文件
    #plt.savefig("../report/images/pretrain.png")
    # lasttrain训练出来的png文件
    #plt.savefig("../report/images/lasttrain.png")
    #preBigTrain训练出来的png文件
    #plt.savefig("../report/images/preBigTrain.png")
    #pretrain训练出来的png文件
    plt.savefig("../report/images/lastBigTrain.png")
...
def nn_model(train_x,train_y,test_x):
	...
	model.add(Embedding(output_dim=30,
						input_dim=30,
						input_length=30))
