...
####################################################################
#training_file = '../HMMdata/trainingdata.txt'
#result_training = '../HMMdata/trainingPosition.txt'

#对照组测试
training_file = '../HMMdata/bigTrainingdata.txt'
result_training = '../HMMdata/bigTrainingPosition.txt'
...
test_file = '../HMMdata/testdata.txt'
if len(sys.argv)>=2:
